...
export const api = axios.create({
    // Vercel busca esta variable. Si no la encuentra, usa la de Azure como respaldo
    baseURL,
    headers: {
        'Content-Type': 'application/json',
    },
});
// Interceptor: Antes de que salga cualquier petición, le inyecta el Token JWT si existe
